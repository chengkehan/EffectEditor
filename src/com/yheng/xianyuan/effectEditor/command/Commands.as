	...
	public class Commands extends com.codeTooth.actionscript.command.Commands
	{
		public function Commands()
		{
			addCommandsCall(
				...
				new CommandItem(CommandID.OUTPUT_IMAGE, new OutputImageCommand()), 
				new CommandItem(CommandID.OUTPUT_EFFECT_AND_IMAGE, new OutputEffectAndImageCommand()), 
				new CommandItem(CommandID.MERGE_EFFECTS, new MergeEffectsCommand()), 
				new CommandItem(CommandID.MERGE_IMAGES, new MergeImagesCommand()), 
				new CommandItem(CommandID.MERGE_EFFECTS_AND_IMAGES, new MergeEffectsAndImagesCommand()), 
